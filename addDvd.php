...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($validator->success()) {
        ...
        header('Location: addDvd.php?success');
    }
}
    ...
    <main>
        ...
        <form action="" method="POST">
            <div>
                ...
                <div class="product-tabs">
                    <input type="text" name="price" placeholder="Product price EUR" autocomplete="off"
                ...
                <div class="product-tabs">
                    <input type="text" name="size" placeholder="Size in MB" autocomplete="off"
